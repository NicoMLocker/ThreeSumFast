...
public class ThreeSumFast {
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("ThreeSumFast-Exp1.txt");
    ...
    public static void runFullExperiment(String resultsFileName){
        ...
        for(int inputSize=MININPUTSIZE;inputSize<=MAXINPUTSIZE; inputSize*=2) {
            ...
            for (long trial = 0; trial < numberOfTrials; trial++) {
                ...
                ThreeSumFast.threeSum(testList);
    ...
    public static long threeSum (long[] list){
        ...
        for(int i = 0; i < n; i++){
            for(int j = i + 1; j < n; j++){
                if(binarySearch(list, -list[i]-list[j] ) > j){
                    count++;
                }
            }
        }
    ...
    public static int binarySearch (long[] list, long lookFor){
        int i = 0;
        int j = list.length - 1;
